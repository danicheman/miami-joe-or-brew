...
if(!empty($_GET['page']) && in_array($_GET['page'],['start','win', 'lose','game'])) {
    ...
    if($_GET['page']=='win') {
        ...
        $jumbotron_message = '<p>Congratulations! You win nothing!</p>
        <a href="?page=game" class="btn btn-lg btn-success" href="#" role="button" style="margin-top: 30px; font-size: 3em; padding: .2em 1.5em">Play again!</a>
